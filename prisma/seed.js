...
async function main() {
    ...
    const attributes = [
        { name: "Shoe Size", slug: "shoe-size", displayType: "BUTTON", values: ["UK 6", "UK 7", "UK 8", "UK 9", "UK 10"] },
        { name: "T-Shirt Size", slug: "t-shirt-size", displayType: "BUTTON", values: ["XS", "S", "M", "L", "XL", "XXL"] },
        {
            name: "Color",
            slug: "color",
            displayType: "COLOR",
        ...
        { name: "Gender", slug: "gender", displayType: "SELECT", values: ["Men", "Women", "Unisex", "Kids"] },
        { name: "Fit", slug: "fit", displayType: "BUTTON", values: ["Regular", "Slim", "Oversized"] },
        { name: "Material", slug: "material", displayType: "SELECT", values: ["Cotton", "Polyester", "Leather", "Mesh"] },
        { name: "Shoe Type", slug: "shoe-type", displayType: "SELECT", values: ["Running", "Casual", "Sports"] },
    ];
